...
<context>
    ...
    <message>
        ...
        <translation>Minerar com seu computador ajuda a fortalecer a rede do Loki. Quanto mais pessoas minerarem, mais difícil é para a rede ser atacada, qualquer quantidade ajuda. &lt;br&gt; &lt;br&gt;Minerar também lhe garante uma pequena chance de ganhar Loki. Seu computador irá criar hashes buscando por soluções aos blocos. Caso encontre um bloco, você receberá a recompensa associada. Boa sorte!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <source>This page allows you to interact with the shared ring database. This database is meant for use by Loki wallets as well as wallets from Loki clones which reuse the Loki keys.</source>
        <translation>Essa página te permite interagir com a base de dados compartilhada dos anéis. Essa base de dados serve para ser usada por carteiras Loki e outras carteiras de clones do Loki que reutilizam as mesmas chaves.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>In order to avoid nullifying the protection afforded by Loki&apos;s ring signatures, an output should not be spent with different rings on different blockchains. While this is normally not a concern, it can become one when a key-reusing Loki clone allows you do spend existing outputs. In this case, you need to ensure this existing outputs uses the same ring on both chains.&lt;br&gt;This will be done automatically by Loki and any key-reusing software which is not trying to actively strip you of your privacy.&lt;br&gt;If you are using a key-reusing Loki clone too, and this clone does not include this protection, you can still ensure your transactions are protected by spending on the clone first, then manually adding the ring on this page, which allows you to then spend your Loki safely.&lt;br&gt;If you do not use a key-reusing Loki clone without these safety features, then you do not need to do anything as it is all automated.&lt;br&gt;</source>
        <translation>Para evitar que a proteção das assinaturas em anel seja anulada, uma saída não pode ser utilizada em anéis diferentes em blockchains diferentes. Isso normalmente não é um problema, mas pode vir a se tornar um caso um clone do Loki que reutiliza as mesmas chaves te permita reutilizar essas saídas. Nesse caso, você precisa se assegurar que essas saídas utilizem o mesmo anel em ambos os blockchains.&lt;br&gt;Isso será feito automaticamente pelo Loki e qualquer outro software de reutilização de chaves que não esteja tentando danificar sua privacidade de forma arbitrária.&lt;br&gt;Se você também utiliza algum clone do Loki com as mesmas chaves, ainda é possível garantir que suas transações estão protegidas ao gastar suas saídas primeiramente no clone, e então adicionar o anel nessa página, que te permitirá usar seu Loki de forma segura.&lt;br&gt;Se você não utiliza um clone do Loki sem esses recursos de segurança, não é preciso fazer nada, pois tudo está automatizado.&lt;br&gt;</translation>
    </message>
    <message>
        <location filename="../pages/SharedRingDB.qml" line="267"/>
        <source>This records rings used by outputs spent on Loki on a key reusing chain, so that the same ring may be reused to avoid privacy issues.</source>
        <translation>Isso registra os anéis usados pelo Loki em um blockchain que reutiliza as mesmas chaves. Dessa maneira o mesmo anel pode ser reutilizado evitando problemas de privacidade.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>I intend to spend on key-reusing fork(s)</source>
        <translation>Eu pretendo usar um fork que reutiliza as chaves do Loki</translation>
    </message>
    <message>
        <location filename="../pages/SharedRingDB.qml" line="378"/>
        <source>I might want to spend on key-reusing fork(s)</source>
        <translation>Talvez eu queria usar um fork que reutiliza as chaves do Loki</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Modo de conservação de espaço no disco utiliza menos espaço, porém a mesma quantidade de banda que o modo normal. Armazenar o blockchain completo ajuda a proteger a rede do Loki. Caso esteja em um dispositivo com espaço em disco limitado, esta opção é para você.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>A mineração protege a rede do Loki e recompensa o minerador com uma pequena quantidade de Loki pelo trabalho feito. Esta opção fará com que seu computador seja utilizado para minerar Loki quando estiver ocioso. A mineração será interrompida quando você voltar a utilizar o computador.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Para se comunicar com a rede Loki, sua carteira precisa estar conectada com um nó Loki. Para maior privacidade, é recomendado que você rode seu próprio nó.                         &lt;br&gt;&lt;br&gt;                         Se você não tem a opção de rodar seu próprio nó, existe a opção de conectar-se a um nó remoto.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Para cada transação uma pequena taxa é coletada. Esta opção permite você adicionar uma quantidade adicional (porcentagem desta taxa) para ajudar o desenvolvimento do Loki. Por exemplo, 50% de auto-doação em uma taxa de transferência de 0.005 XMR adicionará 0.0025 XMR na taxa para ajudar o desenvolvimento do projeto.</translation>
    </message>
    <message>
...
Índice do endereço de envio: </translation>
    ...
    <message>
        ...
        <translation>Loki enviado com sucesso: %1 transação(ões) </translation>
    </message>
    <message>
